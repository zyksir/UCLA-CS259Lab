...
int main() {
  ...
  conv_test.test_cuda(conv_batch, conv_batch_gridblock, "CUDA BATCH", 
    reformat_input, reformat_weight, reformat_output);
  conv_test.test_cuda(conv_batch_shared, conv_batch_gridblock, "CUDA BATCH SHARED", 
    reformat_input, reformat_weight, reformat_output);
  conv_test.test_cuda(conv_channel_subblock_shared, conv_channel_subblock_gridblock, 
    "CUDA CHANNEL SUBBLOCK", reformat_input, reformat_weight, reformat_output);
}
